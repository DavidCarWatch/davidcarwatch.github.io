...
o.find(".color-box.selectable").on("click",function(e){
  ...
  a.val(n),
  x.css("background-color",n.replace(/^0x/,"#")),
  o.find(".color-box-wrap").removeClass("show")
}),

a.bind('change', function() {
  x.css('background-color', a.val().replace(/^0x/, '#'));
})
